export const homeFallback = {
  hero: {
    ...
    description:
      'MTI Interiors and Decor delivers elegant curtains, blinds, wallpapers, flooring, furniture, and complete interior styling with a premium showroom experience.',
  },
  offer: {
...
export const projectFallback = [
  ...
  },
  {
    id: 'project-5',
    category: 'Blinds',
    title: 'Skyline studio shading',
    location: 'Multan',
    description:
      'Motorized roller blinds installed for glare control and privacy in a compact high-rise studio.',
  },
];
...
export const productFallback = [
  ...
  {
    id: 'product-5',
    name: 'Stonegrain vinyl planks',
    category: 'Flooring',
    material: 'Waterproof vinyl',
    specification:
      'Durable plank flooring designed for residential and commercial foot traffic.',
    price: 90,
    swatch: 'linear-gradient(135deg, #87796c, #d7cec4)',
  },
  {
    id: 'product-6',
    name: 'Ceramic sculpt decor set',
    category: 'Decor',
    material: 'Hand-finished ceramic',
    specification:
      'Three-piece decor collection for shelving, coffee tables, or bedroom styling.',
    price: 110,
    swatch: 'linear-gradient(135deg, #d9c7b7, #faf3e8)',
  },
];
...
export const advantageFallback = [
  {
    title: 'Complete material coordination',
    description:
      'Curtains, blinds, wallpaper, flooring, and furniture are selected together so the final result feels cohesive.',
  },
  {
    title: 'Showroom-backed decision making',
    description:
      'Clients can compare textures, finishes, and styling directions with clearer guidance before committing.',
  },
  {
    title: 'Professional installation support',
    description:
      'From measurements to final placement, the service experience is managed with consistency and care.',
  },
];
